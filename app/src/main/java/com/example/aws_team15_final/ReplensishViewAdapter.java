...
//
//public class ReplensishViewAdapter extends RecyclerView.Adapter<ReplensishViewAdapter.replenishViewHolder>{
...
//    RecyclerViewAdapter.ButtonClickListener buttonClickListener_res;
//
//    public RecyclerViewAdapter(ArrayList<Integer> test_arr,ArrayList<String> test_items_arr,ArrayList<Integer> test_quantity_arr, ArrayList<Integer> test_cnt_arr, RecyclerViewAdapter.ButtonClickListener buttonClickListener) {
...
//    @NonNull
//    @Override
//    public RecyclerViewAdapter.replenishViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
//        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.avaliable_items,parent,false);
//        return new RecyclerViewAdapter.reserveViewHolder(view,buttonClickListener_res);
//    }
//
//    @Override
//    public void onBindViewHolder(@NonNull RecyclerViewAdapter.reserveViewHolder holder, int position) {
...
//    }
//    public static class replenishViewHolder extends Re.ViewHolder implements View.OnClickListener
//    {
//
//        ImageView imageView;
...
//        Button cnt_plus;
//        Button cnt_minus;
//        RecyclerViewAdapter.ButtonClickListener buttonClickListener;
//        public reserveViewHolder(@NonNull View itemView, RecyclerViewAdapter.ButtonClickListener buttonClickListener) {
//            super(itemView);
